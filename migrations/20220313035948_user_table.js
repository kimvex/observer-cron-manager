...
exports.up = function(knex) {
  ...
  .createTable('cron_jobs', (table) => {
    ...
    table.string('cron_job_expression', 250).nullable();
    table.integer('cron_minute', 2).nullable();
    table.integer('cron_hour', 2).nullable();
    table.integer('cron_day', 2).nullable();
    table.integer('cron_month', 2).nullable();
    table.integer('cron_year', 4).nullable();
    table.string('type', 250).notNullable();
    table.string('url', 254).nullable();
    table.string('method', 254).nullable();
    table.string('headers', 254).nullable();
    table.string('body', 254).nullable();
